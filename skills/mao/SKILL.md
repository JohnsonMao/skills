---
name: mao
description: Opinionated React/TypeScript tooling and conventions (ESLint, pnpm, Vite/Next.js, Tailwind). Use when setting up new projects, configuring lint/format, monorepos, or building React apps.
metadata:
  version: "2026.02.07"
---
...
| App Development | React/Next.js and Tailwind conventions and patterns | [app-development](references/app-development.md) |
